# Diffs from original file in Corundum:
# + echo 'set_param synth.elaboration.rodinMoreOptions "rt::set_parameter var_size_limit 2097152"' >> run_synth.tcl
#      - the above line is added to support arrays sized larger than 1M.
